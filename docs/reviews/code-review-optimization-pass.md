...
- **Next optimization target**: Fire Fix can get the same flavor treatment as Rivet/Brick by turning extinguished flames into harmless picnic payoffs while preserving the existing spray-only No-Fail floor.
