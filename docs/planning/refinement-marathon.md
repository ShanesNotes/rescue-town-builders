...
| 4 | No-Fail floors & Aim clarity: P1-09 match/journey auto-resolve after misses, P1-12 aim dead-zone + auto-pan, P3-05 bold aim cone, P3-04 helper sprite, P1-08 ≥2-star floor; +6 convergence tests (proven exhaustively in review) | 5 | typecheck✓ test✓(120) build✓ e2e✓(6) | (this commit) |

**Next:** Wave 5 — Reward loop: P2-01 land on the just-lit house, P2-02 tap the new sticker from celebration, P1-10 locked-sticker feedback, P1-07 secrets persist across reloads, P2-08 secret pre-threshold charge, P3-08 journey secrets. Then Waves 6–8 per [child-playthrough-backlog.md](./child-playthrough-backlog.md).
