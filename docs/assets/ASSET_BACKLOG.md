...
## Hearthlight roadmap portrait batch 1 ledger — 2026-06-04

These roadmap helper portraits are original and IP-safe. Fresh built-in `image_gen` calls were rendered on flat chroma-key backgrounds, copied from `/home/ark/.codex/generated_images/019e9206-b393-7a43-af97-beb0bd4c92d6/`, processed through the installed chroma-key remover, centered on transparent 256x256 canvases, and quantized to the locked 10-color Hearthlight RGB palette. Cluckle-inverse uses the existing Cluckle hero portrait and was not regenerated in this batch.

| Key | Prompt | Imported path | Provenance | Notes |
| --- | ------ | ------------- | ---------- | ----- |
| `hl.char.wings` | Wings frog hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/wings.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a2149ec6f508199af8dc76306d97dcf.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.scoot` | Scoot bear hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/scoot.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214a60f2988199925460660fa160a4.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.dash` | Dash squirrel hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/dash.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214acbdf548199967ed13329487460.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.reed` | Reed mouse hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/reed.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214b7ed33c8199979f65c8611230a0.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.milo` | Milo rabbit hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/milo.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214c12a79c819993706aa711a173de.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.grumble` | Mayor Grumble mole hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/grumble.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214c856da481999109db5817360779.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.merry` | Mayor Merry sheep hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/merry.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214d0868ac8199bea05ad8d9e6b60a.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.cluckle` | Existing Cluckle inverse-dream hero prompt in `docs/design/roadmap-characters.md`; no new batch-1 image render because Cluckle already exists and remains wired. | `public/assets/hearthlight/characters/cluckle.png` | Existing 2026-06-03 Hearthlight Cluckle character PNG from the generated asset ledger above. | Existing transparent RGBA portrait retained unchanged. |
| `hl.char.coral` | Captain Coral otter hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/coral.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214d97894c81998ee7976a2fe53683.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.benny` | Baker Benny pig hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/benny.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214e143a9481999a8a844f19327716.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |
| `hl.char.nova` | Nova Noodle weasel hero prompt from `docs/design/roadmap-characters.md`, rendered as a 256x256 Hearthlight pixel-art portrait with flat `#00ff00` chroma-key background, locked palette, upper-left warm light, no text/logos/third-party likeness. | `public/assets/hearthlight/characters/nova.png` | Built-in `image_gen` raw `ig_0282d699a082f59a016a214e9726ec8199bbfb5a777450163f.png`; `remove_chroma_key.py`; local crop/scale/palette cleanup. | 256x256 transparent RGBA; 10 locked visible RGB colors. |

### Roadmap portrait batch 1 shared prompt contract

Every new batch-1 portrait prompt used this shared production frame around the character-specific text from `docs/design/roadmap-characters.md`:

```text
Use case: stylized-concept
Asset type: transparent pixel-art game character portrait, final target 256x256 PNG
Style contract: original IP-safe design, no Paw Patrol or third-party likeness, no text, no logo, no watermark. Match existing Hearthlight portraits Rivet, Brick, Ember, and Cluckle exactly in chunky pixel-art line weight, warm upper-left light, large friendly eyes, centered full-body portrait crop, generous padding, crisp visible pixels, flat fills, minimal dither, no anti-aliasing, no smooth gradients. Locked Hearthlight palette only: #1B2A41 #3A4D6B #572D42 #A73428 #E86F3A #F4A24C #FFC857 #FFE6A3 #43A29C #EBDDDA.
Background for removal: perfectly flat solid #00ff00 chroma-key background, one uniform color with no shadows, gradients, texture, floor plane, reflections, or lighting variation. Do not use #00ff00 anywhere in the subject. No cast shadow or contact shadow.
```

Roadmap portrait batch 1 handoff — changed files: `public/assets/hearthlight/characters/wings.png`, `public/assets/hearthlight/characters/scoot.png`, `public/assets/hearthlight/characters/dash.png`, `public/assets/hearthlight/characters/reed.png`, `public/assets/hearthlight/characters/milo.png`, `public/assets/hearthlight/characters/grumble.png`, `public/assets/hearthlight/characters/merry.png`, `public/assets/hearthlight/characters/coral.png`, `public/assets/hearthlight/characters/benny.png`, `public/assets/hearthlight/characters/nova.png`, `src/game/data/hearthlightAssets.ts`, `docs/assets/ASSET_BACKLOG.md` · verified: `npm run build` passed; static PNG checks passed for 256x256 transparent RGBA and 10 locked visible RGB colors; manifest key checks passed for all 10 new `hl.char.*` keys; `hl.char.cluckle` retained unchanged.

## Hearthlight roadmap backdrop and content prop batch 2 ledger — 2026-06-04

These roadmap mission backdrops and props are original, IP-safe Codex image-gen outputs. Raw built-in `image_gen` PNGs remain in `/home/ark/.codex/generated_images/019e922e-4c01-7130-8cc1-5d3b8a3bc2e5/`; imported files were copied into the workspace, cropped/resized, chroma-keyed where needed, and quantized without dithering to the locked 10-color Hearthlight palette from `docs/design/design-system.md`.

### Batch 2 mission backdrops

| Key | Imported path | Image-gen provenance | Notes |
| --- | ------------- | -------------------- | ----- |
| `hl.bg.frogFlight` | `public/assets/hearthlight/bg/frog-flight.png` | `ig_05444d3463c2eff1016a2153f120c48190bb3397f049f4394b.png` | Frog Flight mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.scooterRoundup` | `public/assets/hearthlight/bg/scooter-roundup.png` | `ig_05444d3463c2eff1016a21546f9f888190ba4ac339d6153223.png` | Scooter Bear Roundup mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.safetyLights` | `public/assets/hearthlight/bg/safety-lights.png` | `ig_05444d3463c2eff1016a2154eb50e081908d5ecf00aeccd4d1.png` | Safety Lights Chase mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.recycledInventions` | `public/assets/hearthlight/bg/recycled-inventions.png` | `ig_05444d3463c2eff1016a215553f9948190b55739bad5564ad7.png` | Recycled Inventions mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.bikeExplorer` | `public/assets/hearthlight/bg/bike-explorer.png` | `ig_05444d3463c2eff1016a2155b8360c819096cc50574eb327cc.png` | Bike Explorer mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.gooCleanup` | `public/assets/hearthlight/bg/goo-cleanup.png` | `ig_05444d3463c2eff1016a215636e4688190b7b73cb9ba60d547.png` | Goo Cleanup mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.dreamStatues` | `public/assets/hearthlight/bg/dream-statues.png` | `ig_05444d3463c2eff1016a2156ad83e48190a93cfc3a4bac79fa.png` | Dream Statues mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.inverseDream` | `public/assets/hearthlight/bg/inverse-dream.png` | `ig_05444d3463c2eff1016a21571279488190a32e8b77dbb07040.png` | Chicken Inverse Dream mission backdrop with Cluckle microcosm hint. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.treasureBoat` | `public/assets/hearthlight/bg/treasure-boat.png` | `ig_05444d3463c2eff1016a21576f20c081908d3b547e3ea9f0d7.png` | Treasure Boat mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.breadRush` | `public/assets/hearthlight/bg/bread-rush.png` | `ig_05444d3463c2eff1016a2157d6cfc48190a8942b0cd031d244.png` | Bread Rush mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |
| `hl.bg.asteroidBlaster` | `public/assets/hearthlight/bg/asteroid-blaster.png` | `ig_05444d3463c2eff1016a2158306a4c81908c4e9dd912ded514.png` | Asteroid Blaster mission backdrop. 960x540 opaque PNG; locked visible RGB palette. |

### Batch 2 content props

| Key | Imported path | Image-gen provenance | Notes |
| --- | ------------- | -------------------- | ----- |
| `hl.prop.skyRing` | `public/assets/hearthlight/props/sky-ring.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Frog Flight ring target. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.frogFriend` | `public/assets/hearthlight/props/frog-friend.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Frog to rescue. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.leafGlider` | `public/assets/hearthlight/props/leaf-glider.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Frog Flight glider prop. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.rescueBasket` | `public/assets/hearthlight/props/rescue-basket.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Frog Flight rescue basket. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scooter` | `public/assets/hearthlight/props/scooter.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Scooter Roundup movement prop. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.bearFriend` | `public/assets/hearthlight/props/bear-friend.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Scooter Roundup wanderer. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scooterWaypoint` | `public/assets/hearthlight/props/scooter-waypoint.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Scooter Roundup waypoint marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.softFence` | `public/assets/hearthlight/props/soft-fence.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Scooter Roundup guide fence. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.bikeWaypoint` | `public/assets/hearthlight/props/bike-waypoint.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Bike Explorer waypoint marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.mapSticker` | `public/assets/hearthlight/props/map-sticker.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Bike Explorer sticker marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.benchSpot` | `public/assets/hearthlight/props/bench-spot.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Bike Explorer landmark. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.neighborDoor` | `public/assets/hearthlight/props/neighbor-door.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Bike Explorer reveal marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.buoy` | `public/assets/hearthlight/props/buoy.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Treasure Boat buoy marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.treasureChest` | `public/assets/hearthlight/props/treasure-chest.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Treasure Boat chest. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.boatHull` | `public/assets/hearthlight/props/boat-hull.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Treasure Boat hull/raft. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.harborLight` | `public/assets/hearthlight/props/harbor-light.png` | Sheet `ig_05444d3463c2eff1016a21591c35088190833afa6992927280.png` | Treasure Boat shore light. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.trafficLight` | `public/assets/hearthlight/props/traffic-light.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Safety Lights traffic signal. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.safetyLantern` | `public/assets/hearthlight/props/safety-lantern.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Safety Lights lantern signal. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.lampPost` | `public/assets/hearthlight/props/lamp-post.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Safety Lights post marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.crosswalkMark` | `public/assets/hearthlight/props/crosswalk-mark.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Safety Lights crosswalk marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.softHook` | `public/assets/hearthlight/props/soft-hook.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Safety Lights soft hook/lasso tool. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.runawayFriend` | `public/assets/hearthlight/props/runaway-friend.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Safety Lights friendly moving target. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gooBlobSmall` | `public/assets/hearthlight/props/goo-blob-small.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Goo Cleanup small cleanable blob. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gooBlobLarge` | `public/assets/hearthlight/props/goo-blob-large.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Goo Cleanup large cleanable blob. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.grumbleMop` | `public/assets/hearthlight/props/grumble-mop.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Goo Cleanup Grumble's mop. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.grumbleSpray` | `public/assets/hearthlight/props/grumble-spray.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Goo Cleanup Grumble's spray tool. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.cleanPatch` | `public/assets/hearthlight/props/clean-patch.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Goo Cleanup clean result patch. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gooSplatTarget` | `public/assets/hearthlight/props/goo-splat-target.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Goo Cleanup splat target. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.asteroidSmall` | `public/assets/hearthlight/props/asteroid-small.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Asteroid Blaster small drifting asteroid. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.asteroidLarge` | `public/assets/hearthlight/props/asteroid-large.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Asteroid Blaster large drifting asteroid. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.foamStar` | `public/assets/hearthlight/props/foam-star.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Asteroid Blaster foam-star projectile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.foamBlaster` | `public/assets/hearthlight/props/foam-blaster.png` | Sheet `ig_05444d3463c2eff1016a215994d1f0819094cf460739c3bc80.png` | Asteroid Blaster foam blaster tool. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseSun` | `public/assets/hearthlight/props/inverse-sun.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream sun tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseMoon` | `public/assets/hearthlight/props/inverse-moon.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream moon tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseHotEmber` | `public/assets/hearthlight/props/inverse-hot-ember.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream hot ember tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseColdSnowflake` | `public/assets/hearthlight/props/inverse-cold-snowflake.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream cold snowflake tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseBig` | `public/assets/hearthlight/props/inverse-big.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream big tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseSmall` | `public/assets/hearthlight/props/inverse-small.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream small tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseDay` | `public/assets/hearthlight/props/inverse-day.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream day tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseNight` | `public/assets/hearthlight/props/inverse-night.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream night tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseLoud` | `public/assets/hearthlight/props/inverse-loud.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream loud tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseQuiet` | `public/assets/hearthlight/props/inverse-quiet.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream quiet tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.dreamWell` | `public/assets/hearthlight/props/dream-well.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream well marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.inverseSlot` | `public/assets/hearthlight/props/inverse-slot.png` | Sheet `ig_05444d3463c2eff1016a2159f021488190a82d722c654aa2cf.png` | Inverse Dream slot marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.statueHen` | `public/assets/hearthlight/props/statue-hen.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues hen statue. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.statueCloud` | `public/assets/hearthlight/props/statue-cloud.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues cloud statue. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.statueMoon` | `public/assets/hearthlight/props/statue-moon.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues moon statue. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.statueLeaf` | `public/assets/hearthlight/props/statue-leaf.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues leaf statue. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plinthHen` | `public/assets/hearthlight/props/plinth-hen.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues hen plinth marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plinthCloud` | `public/assets/hearthlight/props/plinth-cloud.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues cloud plinth marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plinthMoon` | `public/assets/hearthlight/props/plinth-moon.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues moon plinth marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plinthLeaf` | `public/assets/hearthlight/props/plinth-leaf.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues leaf plinth marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plinthGeneric` | `public/assets/hearthlight/props/plinth-generic.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues generic plinth marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plinthWell` | `public/assets/hearthlight/props/plinth-well.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues well plinth marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.dreamCloud` | `public/assets/hearthlight/props/dream-cloud.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues dream cloud prop. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.statueBase` | `public/assets/hearthlight/props/statue-base.png` | Sheet `ig_05444d3463c2eff1016a215a6e505481908e8096de5947c034.png` | Dream Statues generic base. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scrapGear` | `public/assets/hearthlight/props/scrap-gear.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions scrap gear. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scrapSpring` | `public/assets/hearthlight/props/scrap-spring.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions scrap spring. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scrapTube` | `public/assets/hearthlight/props/scrap-tube.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions scrap tube. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scrapWheel` | `public/assets/hearthlight/props/scrap-wheel.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions scrap wheel. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.scrapSparkCore` | `public/assets/hearthlight/props/scrap-spark-core.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions spark core. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gadgetBody` | `public/assets/hearthlight/props/gadget-body.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions gadget body. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gadgetSlotGear` | `public/assets/hearthlight/props/gadget-slot-gear.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions gear slot marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gadgetSlotSpring` | `public/assets/hearthlight/props/gadget-slot-spring.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions spring slot marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gadgetSlotTube` | `public/assets/hearthlight/props/gadget-slot-tube.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions tube slot marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gadgetSlotWheel` | `public/assets/hearthlight/props/gadget-slot-wheel.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions wheel slot marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.gadgetSlotCore` | `public/assets/hearthlight/props/gadget-slot-core.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions core slot marker. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.assembledGadget` | `public/assets/hearthlight/props/assembled-gadget.png` | Sheet `ig_05444d3463c2eff1016a215ac58e508190a54b8313a209aa06.png` | Recycled Inventions completed gadget. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.ingredientFlour` | `public/assets/hearthlight/props/ingredient-flour.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush flour tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.ingredientWater` | `public/assets/hearthlight/props/ingredient-water.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush water tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.ingredientYeast` | `public/assets/hearthlight/props/ingredient-yeast.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush yeast tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.ingredientDough` | `public/assets/hearthlight/props/ingredient-dough.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush dough tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.ingredientButter` | `public/assets/hearthlight/props/ingredient-butter.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush butter tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.breadLoaf` | `public/assets/hearthlight/props/bread-loaf.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush bread loaf tile. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.ovenSlot` | `public/assets/hearthlight/props/oven-slot.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush oven slot. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.plateSlot` | `public/assets/hearthlight/props/plate-slot.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush plate slot. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.recipeCard` | `public/assets/hearthlight/props/recipe-card.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush sequence recipe card. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.deliveryBasket` | `public/assets/hearthlight/props/delivery-basket.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush delivery basket. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.mixingBowl` | `public/assets/hearthlight/props/mixing-bowl.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush mixing bowl. 128x128 transparent PNG; locked visible RGB palette. |
| `hl.prop.breadCrate` | `public/assets/hearthlight/props/bread-crate.png` | Sheet `ig_05444d3463c2eff1016a215b5a67ec8190a5b511f826635d7f.png` | Bread Rush bread crate. 128x128 transparent PNG; locked visible RGB palette. |

Roadmap backdrop and content prop batch 2 handoff — changed files: 11 new `public/assets/hearthlight/bg/*.png` roadmap mission backdrops, 80 new `public/assets/hearthlight/props/*.png` content props, `src/game/data/hearthlightAssets.ts`, `docs/assets/ASSET_BACKLOG.md` · verified: `npm run build` passed; static PNG checks passed for 960x540 opaque backdrops, 128x128 transparent props, and 10 locked visible RGB colors; manifest key checks passed for all 91 new `hl.bg.*` / `hl.prop.*` keys · risks: prop sheets were cropped from generated multi-cell sheets, so a few slot/marker tiles are intentionally generic rather than mission-logic-specific.
